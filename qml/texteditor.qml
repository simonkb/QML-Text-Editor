...
ApplicationWindow {
    ...
    Action {
        ...
        text: qsTr("Font Size...")
        onTriggered: {
            var result = Platform.fontDialog.open()
            if (result) {
                document.size = Platform.fontDialog.selectedSize
            }
        }
    }
    ...
    DocumentHandler {
        ...
        size: textArea.font.pixelSize // Assuming textArea is your text editing component
